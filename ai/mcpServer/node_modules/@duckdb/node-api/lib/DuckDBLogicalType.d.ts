...
import { DuckDBArrayType, DuckDBDecimalType, DuckDBEnumType, DuckDBGeometryType, DuckDBListType, DuckDBMapType, DuckDBStructType, DuckDBType, DuckDBUnionType } from './DuckDBType';
...
export declare class DuckDBGeometryLogicalType extends DuckDBLogicalType {
    get crs(): string | undefined;
    asType(): DuckDBGeometryType;
}
