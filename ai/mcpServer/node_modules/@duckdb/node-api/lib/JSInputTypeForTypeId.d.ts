...
export interface JSInputTypeForTypeId {
    ...
    [DuckDBTypeId.VARIANT]: DuckDBVariantValue | boolean | number | bigint | string;
}
/**
 ...
 */
export type JSInputTypeFor<T extends DuckDBType> = JSInputTypeForTypeId[T['typeId']];
