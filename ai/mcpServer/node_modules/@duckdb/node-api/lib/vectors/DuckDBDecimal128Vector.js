...
exports.DuckDBDecimal128Vector = void 0;
...
class DuckDBDecimal128Vector extends DuckDBVector_1.DuckDBVector {
    decimalType;
    dataView;
    validity;
    vector;
    ...
    getItem(itemIndex) {
        return this.validity.itemValid(itemIndex)
            ? (0, dataAccessors_1.getDecimal128)(this.dataView, itemIndex * 16, this.decimalType)
            : null;
    }
    getScaledValue(itemIndex) {
        return this.validity.itemValid(itemIndex)
            ? (0, dataAccessors_1.getInt128)(this.dataView, itemIndex * 16)
            : null;
    }
    setItem(itemIndex, value) {
        if (value != null) {
            (0, dataAccessors_1.setInt128)(this.dataView, itemIndex * 16, value.value);
