...
exports.DuckDBDoubleVector = void 0;
...
class DuckDBDoubleVector extends DuckDBVector_1.DuckDBVector {
    items;
    validity;
    vector;
    ...
    static fromRawVector(vector, itemCount) {
        const data = (0, dataAccessors_1.vectorData)(vector, itemCount * Float64Array.BYTES_PER_ELEMENT);
