...
exports.DuckDBUHugeIntVector = void 0;
...
class DuckDBUHugeIntVector extends DuckDBVector_1.DuckDBVector {
    dataView;
    validity;
    vector;
    _itemCount;
    ...
    getItem(itemIndex) {
        return this.validity.itemValid(itemIndex)
            ? (0, dataAccessors_1.getUInt128)(this.dataView, itemIndex * 16)
            : null;
    }
    getDouble(itemIndex) {
        return this.validity.itemValid(itemIndex)
            ? node_bindings_1.default.uhugeint_to_double((0, dataAccessors_1.getUInt128)(this.dataView, itemIndex * 16))
            : null;
    }
    setItem(itemIndex, value) {
        if (value != null) {
            (0, dataAccessors_1.setUInt128)(this.dataView, itemIndex * 16, value);
