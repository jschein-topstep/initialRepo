...
exports.DuckDBGeometryLogicalType = exports.DuckDBUnionLogicalType = exports.DuckDBArrayLogicalType = exports.DuckDBMapLogicalType = exports.DuckDBStructLogicalType = exports.DuckDBListLogicalType = exports.DuckDBEnumLogicalType = exports.DuckDBDecimalLogicalType = exports.DuckDBLogicalType = void 0;
...
class DuckDBLogicalType {
    ...
    static create(logical_type) {
        switch (node_bindings_1.default.get_type_id(logical_type)) {
            ...
            case node_bindings_1.default.Type.GEOMETRY:
    ...
    asType() {
        ...
        switch (this.typeId) {
            ...
            case DuckDBTypeId_1.DuckDBTypeId.VARIANT:
                return DuckDBType_1.DuckDBVariantType.create(alias);
            default:
...
class DuckDBGeometryLogicalType extends DuckDBLogicalType {
    get crs() {
        return node_bindings_1.default.geometry_type_get_crs(this.logical_type) || undefined;
    }
    asType() {
        return DuckDBType_1.DuckDBGeometryType.create(this.alias, this.crs);
    }
}
exports.DuckDBGeometryLogicalType = DuckDBGeometryLogicalType;
