 ...
 */
export type ToDuckDBValueConverter<T> = (value: T, type: DuckDBType, converter: ToDuckDBValueConverter<T>) => DuckDBValue;
/**
 ...
 */
export type ToDuckDBValueConverterFor<In, Nested> = (value: In, type: DuckDBType, converter: ToDuckDBValueConverter<Nested>) => DuckDBValue;
/**
 ...
 * `Expected ...` error.
 */
export declare function createToDuckDBValueConverter<T, InputTable extends Record<DuckDBTypeId, unknown>>(convertersByTypeId: {
