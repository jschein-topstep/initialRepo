 ...
 */
export declare class DuckDBVariantValue {
    readonly value: DuckDBValue;
    readonly type?: DuckDBType;
    constructor(value: DuckDBValue, type?: DuckDBType);
    toString(): string;
}
export declare function variantValue(value: DuckDBValue, type?: DuckDBType): DuckDBVariantValue;
