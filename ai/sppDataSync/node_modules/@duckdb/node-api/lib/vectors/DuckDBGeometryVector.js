...
exports.DuckDBGeometryVector = void 0;
...
class DuckDBGeometryVector extends DuckDBVector_1.DuckDBVector {
    dataView;
    validity;
    vector;
    itemOffset;
    ...
    getItem(itemIndex) {
        return this.validity.itemValid(itemIndex)
            ? new values_1.DuckDBGeometryValue((0, dataAccessors_1.getBuffer)(this.dataView, itemIndex * 16))
            : null;
    }
