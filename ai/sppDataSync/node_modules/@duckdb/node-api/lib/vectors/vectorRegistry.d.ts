...
export type CreateDuckDBVectorFn = (vector: duckdb.Vector, itemCount: number, knownType?: DuckDBType) => DuckDBVector<DuckDBValue>;
/**
 * @internal
 ...
 */
export declare const vectorRegistry: {
    create?: CreateDuckDBVectorFn;
};
